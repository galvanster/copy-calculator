...
@Component({
  selector: 'copy-calculator',
  templateUrl: './copy-calculator.component.html',
  styleUrls: ['./copy-calculator.component.scss']
})
export class CopyCalculatorComponent implements OnInit {
